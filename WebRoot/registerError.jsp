...
<html>
  ...
  <body>
  	<div id="background" style="background-color:#D1D1D1;">
  		<h1 class="absolute textCenter">很遗憾，注册失败！</h1>
		<div class="absolute page">
			<a class="btn btn-lg btn-success" href="${pageContext.request.contextPath}/login.jsp">点击返回注册</a>
		</div>	
  	</div>
  </body>
</html>