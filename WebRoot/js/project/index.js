...
window.onload = function(){
	...
	function workContent(){
		//oWorksContent2
		var data = [
			{ img : '../image/index/worksimg1.jpg' , text : '测试文字，哈哈哈啊司法所地1' },
			{ img : '../image/index/worksimg2.jpg' , text : '测试文字，哈哈哈啊司法所地2' },
			{ img : '../image/index/worksimg3.jpg' , text : '测试文字，哈哈哈啊司法所地3' },
			{ img : '../image/index/worksimg4.jpg' , text : '测试文字，哈哈哈啊司法所地4' }
		];
	...
	function courseContent(){
		//oCourseContent3
		var data = [
			{ img : '../image/index/binoli.png' , text : '测试文字111' },
			{ img : '../image/index/bks.png' , text : '测试文字222' },
			{ img : '../image/index/gu.png' , text : '测试文字333' },
			{ img : '../image/index/hlx.png' , text : '测试文字444' },
			{ img : '../image/index/binoli.png' , text : '测试文字111' },
			{ img : '../image/index/binoli.png' , text : '测试文字111' },
			{ img : '../image/index/binoli.png' , text : '测试文字111' },
			{ img : '../image/index/binoli.png' , text : '测试文字111' },
	...
	function showMusic(){
		...
		oMusic.onclick = function(){
			if(onoff){
				this.style.background = 'url(../image/index/musicon.gif)';
				oAudio.play();
			}
			else{
				this.style.background = 'url(../image/index/musicoff.gif)';
				oAudio.pause();
			}
			onoff = !onoff;
		};
